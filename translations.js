...
const translations = {
    en: {
        ...
        workflowStep1: "Submit Request",
        workflowStep2: "Discovery Call",
        workflowStep3: "Quote & Timeline",
        workflowStep4: "Contract Agreement",
        workflowStep5: "Development",
        workflowStep6: "Delivery & Handover",
        ...
        emailDefault: "Default Email App",
        emailGmail: "Gmail",
    ...
    gr: {
        ...
        workflowStep1: "Υποβολή Αιτήματος",
        workflowStep2: "Κλήση Ανακάλυψης",
        workflowStep3: "Προσφορά & Χρονοδιάγραμμα",
        workflowStep4: "Συμφωνία Σύμβασης",
        workflowStep5: "Ανάπτυξη",
        workflowStep6: "Παράδοση & Μεταβίβαση",
        startButton: "Ξεκινήστε Αίτημα",
        
        // Request Form
        formTitle: "Αίτηση Υπηρεσίας",
        formSubtitle: "Συμπληρώστε τα παρακάτω στοιχεία",
        formName: "Όνομα",
        formOrg: "Οργανισμός",
        formOptional: "(προαιρετικό)",
        formEmail: "Email",
        formService: "Υπηρεσία",
        ...
        emailDefault: "Προεπιλεγμένη Εφαρμογή Email",
        emailGmail: "Gmail",
